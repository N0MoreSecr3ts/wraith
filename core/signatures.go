...
func LoadSignatures(filePath string, mLevel int, sess *Session) []Signature {
	...
	sess.RulesVersion = rulesMetaData.Version

	losSimpleSignatures := []SimpleSignature{}
	losPatternSignatures := []PatternSignature{}
...
func (s PatternSignature) Enable() bool {
	return s.enable
}
...
// Enable sets whether as signature is active or not
func (s SimpleSignature) Enable() bool {
	return s.enable
}
