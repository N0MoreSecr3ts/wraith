...
- Stop disabling TLS certificate verification for plain github.com clients; `InsecureSkipVerify` is now scoped to `github-enterprise` only, for instances with self-signed certificates
